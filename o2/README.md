...
<u>**md5-hasher.py**  </u> <br> Ett modifierat Python-script som genererar slumpmässiga numeriska lösenord och ger output med en lista av 10st hashes av lämplig längd för att motstå attacker av rainbow tables. <br> [CrackStation](https://www.crackstation.net) är en populär onlinetjänst som erbjuder rainbow-table sökningar för att knäcka hashvärden. Rainbow-tables fungerar bara på hashfunktioner utan salt och blir snabbt ineffektiva vid längre eller mer komplexa lösenord.
